        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
              ...
              {items.map((item) => (
                <div
                  ...
                  className={`relative p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer transition-all duration-200 ${
                    longPressedItem === item.id ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-700'
                  }`}
            ...
            {showContextMenu && (
              ...
              >
                <button
                  onClick={() => handleContextMenuAction('Copy', longPressedItem!)}
                ...
                <button
                  onClick={() => handleContextMenuAction('Share', longPressedItem!)}
                  className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-2"
                >
                  <span>📤</span>
                  <span>Share</span>
                ...
                <button
                  onClick={() => handleContextMenuAction('Rename', longPressedItem!)}
                  className="w-full px-4 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center space-x-2"
                >
                  <span>✏️</span>
                  <span>Rename</span>
                ...
                <button
                  onClick={() => handleContextMenuAction('Delete', longPressedItem!)}
  ...
  return (
    <div className="space-y-2">
      {items.map((item) => (
        <div
          key={item.id}
          className={\`relative p-4 bg-white rounded-lg border cursor-pointer transition-all duration-200 \${
            longPressedItem === item.id ? 'ring-2 ring-blue-500 bg-blue-50' : 'hover:bg-gray-50'
          }\`}
          onMouseDown={(e) => handleMouseDown(item.id, e)}
          onMouseUp={handleMouseUp}
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Configurable Duration</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Customizable long press timing</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Dynamic context menus with actions</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Clear indication of long press state</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Click Outside Dismiss</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Auto-dismiss context menus</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Context menus and secondary actions</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">📁</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">File Managers</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">File operations and context menus</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">🎮</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Games</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Secondary actions and power-ups</p>
          </div>
        </div>
      </div>
    </div>
