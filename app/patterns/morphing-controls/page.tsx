...
export default function MorphingControlsPattern() {
  ...
  const handleInputModeChange = () => {
    const modes: ('text' | 'email' | 'password')[] = ['text', 'email', 'password'];
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Search Bar</h3>
                <div className="flex items-center space-x-2">
                  <div className={`relative transition-all duration-300 ${searchMode === 'advanced' ? 'flex-1' : 'w-64'}`}>
                    <input
                      type="text"
                      placeholder={searchMode === 'basic' ? 'Search...' : 'Enter keywords, filters, or advanced queries...'}
              ...
              {/* Morphing Button */}
              <div className="space-y-3">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Action Button</h3>
                <button
              ...
              {/* Morphing Input */}
              <div className="space-y-3">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Adaptive Input</h3>
                <div className="flex items-center space-x-2">
                  <div className="relative flex-1">
                    <input
                      type={inputMode}
                      placeholder={
                        inputMode === 'text' ? 'Enter your name...' :
                        inputMode === 'email' ? 'Enter your email...' :
                        'Enter your password...'
                      }
              ...
              {/* Morphing Toggle */}
              <div className="space-y-3">
                <h3 className="font-medium text-gray-800 dark:text-gray-200">Smart Toggle</h3>
                <button
                  onClick={() => setToggleState(!toggleState)}
                  className={`relative inline-flex items-center h-6 rounded-full transition-all duration-300 ${
                    toggleState ? 'w-12 bg-blue-600' : 'w-6 bg-gray-300 dark:bg-gray-600'
                  }`}
                >
                  <span className={`inline-block w-4 h-4 bg-white rounded-full transition-all duration-300 transform ${
...
export default function MorphingControls() {
  ...
  const handleButtonClick = () => {
    ...
    setTimeout(() => {
      setButtonMode('success');
      setTimeout(() => setButtonMode('default'), 2000);
    }, 2000);
  };
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Contextual Adaptation</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Controls change based on current state or mode</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Animated transformations between states</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Progressive Disclosure</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Show more options as needed</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Clear indication of current state</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Expandable search bars with advanced options</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">⚡</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Action Buttons</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Buttons that show progress and completion states</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">🎛️</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Form Controls</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Inputs that adapt to different data types</p>
          </div>
        </div>
      </div>
    </div>
