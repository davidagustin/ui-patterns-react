    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Create collapsible sidebar navigation with hierarchical menu items, perfect for admin dashboards and complex applications.
        </p>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
              A full-featured sidebar with collapsible sections, badges, and nested menu items. Try collapsing the sidebar!
            </p>
                ...
                <nav className="flex-1 p-4 space-y-2">
                  {menuItems.map((item) => (
                    <div key={item.id}>
                      ...
                      {/* Sub Menu */}
                      {hasSubMenu(item.id) && expandedItems.includes(item.id) && !isCollapsed && (
                ...
                <div className="h-full">
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                    {menuItems.find(item => item.id === activeMenuItem)?.name || 
                     subMenuItems.find(item => item.id === activeMenuItem)?.name || 'Content'}
                  </h2>
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-6 h-full border border-gray-200 dark:border-gray-600">
                    <p className="text-gray-600 dark:text-gray-400">
                      This is the main content area. The active menu item is: <strong>{activeMenuItem}</strong>
                    </p>
    ...
    <div className="flex h-screen">
      ...
      <main className="flex-1 p-6 bg-gray-50">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">
          {menuItems.find(item => item.id === activeMenuItem)?.name || 'Content'}
        </h1>
...
.sidebar.collapsed .menu-item-actions,
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Collapsible Design</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Expand and collapse to save space</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Nested Navigation</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Hierarchical menu structure with sub-items</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Badge Notifications</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Visual indicators for counts and alerts</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">User Profile Footer</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">User information and quick access</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Clear visual feedback for current page</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Management interfaces and control panels</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">💼</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Business Applications</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">CRM, ERP, and enterprise software</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">🛠️</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Developer Tools</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">IDEs, code editors, and dev platforms</p>
          </div>
        </div>
      </div>
    </div>
