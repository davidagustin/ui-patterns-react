...
export default function CategorizationPattern() {
  ...
  const items = [
    ...
    },
    {
      ...
      price: "$46.99",
      image:
        "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=300&h=200&fit=crop",
    },
    {
      id: 34,
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Organize and filter content by categories with visual indicators and
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Click on categories to filter items. Each category shows item
              count and uses color coding for easy identification.
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {category && (
                        <span
                          className={`px-2 py-1 text-xs rounded-full flex-shrink-0 ml-2 ${getCategoryColor(category.color)}`}
                        >
                          {category.name}
                        </span>
                      )}
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div className="code-block">
              <DynamicCodeExample componentName="categorization" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
          ...
          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <li>
              • <strong>Dynamic Filtering:</strong> Real-time filtering based on
              selected category
            </li>
            <li>
              • <strong>Visual Indicators:</strong> Color-coded categories for
              easy identification
            </li>
            <li>
              • <strong>Item Counts:</strong> Shows number of items in each
              category
            </li>
            <li>
              • <strong>Responsive Grid:</strong> Adapts to different screen
              sizes
            </li>
            <li>
              • <strong>Smooth Transitions:</strong> Animated category switching
            </li>
            <li>
              • <strong>Accessible Design:</strong> Proper ARIA labels and
              keyboard navigation
            </li>
            <li>
              • <strong>Empty States:</strong> Clear messaging when no items
              match
            </li>
            <li>
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
          ...
          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <li>
              • <strong>E-commerce Stores:</strong> Filter products by category
            </li>
            <li>
              • <strong>Blog Platforms:</strong> Organize articles by topic
            </li>
            <li>
              • <strong>Portfolio Websites:</strong> Showcase work by project
              type
            </li>
            <li>
              • <strong>Recipe Apps:</strong> Filter recipes by cuisine or meal
              type
            </li>
            <li>
              • <strong>Job Boards:</strong> Filter job listings by industry
            </li>
            <li>
              • <strong>Music Libraries:</strong> Organize songs by genre
            </li>
            <li>
              • <strong>Document Management:</strong> Categorize files by type
            </li>
            <li>
              • <strong>Social Media:</strong> Filter posts by content type
            </li>
          </ul>
        </div>
      </div>
