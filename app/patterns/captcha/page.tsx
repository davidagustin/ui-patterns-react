...
export default function CaptchaPattern() {
  ...
  const verifyCaptcha = () => {
    ...
    switch (captchaType) {
      case 'math':
        const expected = mathProblem.operator === '+' ? mathProblem.num1 + mathProblem.num2 :
                        mathProblem.operator === '-' ? mathProblem.num1 - mathProblem.num2 :
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
            ...
            <div className="space-y-6">
              ...
              <div className="flex space-x-2">
                <button
                  onClick={() => { setCaptchaType('image'); resetCaptcha(); }}
                ...
                <button
                  onClick={() => { setCaptchaType('checkbox'); resetCaptcha(); }}
                  className={`px-3 py-2 rounded text-sm font-medium transition-colors ${
                ...
                <button
                  onClick={() => { setCaptchaType('math'); resetCaptcha(); }}
                  className={`px-3 py-2 rounded text-sm font-medium transition-colors ${
                    captchaType === 'math' 
                      ? 'bg-blue-600 text-white' 
                      : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'
                ...
                {isVerified ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={captchaType === 'checkbox' ? false : !userAnswer.trim()}
                    >
                      Verify CAPTCHA
                    </button>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Support for image, checkbox, and math CAPTCHAs</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Alternative options for users with disabilities</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Clear instructions and error handling</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Security</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Effective protection against automated bots</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Form Protection</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Prevent spam submissions on contact forms</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">👤</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">User Registration</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Verify human users during sign-up process</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">💬</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Comment Systems</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Protect against automated comment spam</p>
          </div>
        </div>
      </div>
    </div>
