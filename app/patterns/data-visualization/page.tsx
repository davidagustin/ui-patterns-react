...
export default function DataVisualizationPattern() {
  ...
  const getCurrentData = () => {
    switch (selectedMetric) {
      case 'sales': return salesData[timeRange];
      case 'users': return userData[timeRange];
      case 'revenue': return revenueData[timeRange];
      default: return salesData[timeRange];
    }
  };
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Interactive charts and graphs for displaying complex data with filtering, real-time updates, and responsive design.
        </p>
      </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-medium text-gray-800 dark:text-gray-200">
                    {getMetricLabel()} - {timeRange === '7d' ? '7 Days' : timeRange === '30d' ? '30 Days' : timeRange === '90d' ? '90 Days' : '1 Year'}
                  </h3>
                ...
                {selectedChart !== 'pie' && (
                  <div className="grid grid-cols-4 gap-4 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">{total.toLocaleString()}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Total</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">{average.toLocaleString()}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Average</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">{max.toLocaleString()}</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Max</div>
                    </div>
                    <div className="text-center">
                      <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">{min.toLocaleString()}</div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-lg border">
          ...
          <div className="text-2xl font-bold">
            {getCurrentData().reduce((sum, value) => sum + value, 0).toLocaleString()}
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border">
          <div className="text-sm text-gray-600">Average</div>
          <div className="text-2xl font-bold">
            {Math.round(getCurrentData().reduce((sum, value) => sum + value, 0) / getCurrentData().length).toLocaleString()}
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border">
          <div className="text-sm text-gray-600">Max</div>
          <div className="text-2xl font-bold">
            {Math.max(...getCurrentData()).toLocaleString()}
          </div>
        </div>
        <div className="bg-white p-4 rounded-lg border">
          <div className="text-sm text-gray-600">Min</div>
          <div className="text-2xl font-bold">
            {Math.min(...getCurrentData()).toLocaleString()}
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-6 border border-green-200 dark:border-green-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Multiple Chart Types</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Bar, line, area, and pie charts with smooth transitions</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              <h4 className="font-medium text-gray-800 dark:text-gray-200">Interactive Controls</h4>
              <p className="text-sm text-gray-600 dark:text-gray-400">Real-time chart switching and data filtering</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Summary statistics and data insights</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            <span className="text-green-600 dark:text-green-400 text-lg">✓</span>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Charts adapt to different screen sizes</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Business intelligence and performance tracking</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">📊</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">Financial Reports</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">Revenue, expenses, and financial metrics</p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            <div className="text-2xl mb-2">👥</div>
            <h4 className="font-medium text-gray-800 dark:text-gray-200">User Analytics</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">User behavior and engagement metrics</p>
          </div>
        </div>
      </div>
    </div>
