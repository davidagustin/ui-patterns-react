...
export default function ThumbnailPattern() {
  ...
  const images = [
    { id: 1, title: 'Mountain Landscape', src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&h=600&fit=crop', description: 'Beautiful mountain landscape with snow-capped peaks' },
    { id: 2, title: 'Ocean View', src: 'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=800&h=600&fit=crop', description: 'Serene ocean view with crystal clear waters' },
    { id: 3, title: 'Forest Path', src: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=800&h=600&fit=crop', description: 'Peaceful forest path surrounded by tall trees' },
    { id: 4, title: 'City Skyline', src: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&h=600&fit=crop', description: 'Modern city skyline at sunset' },
    { id: 5, title: 'Desert Dunes', src: 'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=800&h=600&fit=crop', description: 'Golden sand dunes stretching to the horizon' },
    { id: 6, title: 'Garden Flowers', src: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&h=600&fit=crop', description: 'Colorful flowers blooming in a garden' },
  ];
