    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Visualize tag frequency with varying sizes and colors, making it easy
              ...
              {(["technology", "design", "business", "lifestyle"] as const).map(
                (category) => (
                  <div key={category} className="flex items-center space-x-1">
                    <span
                      className={`w-3 h-3 rounded-full ${getTagColor(category).split(" ")[0]}`}
                    ></span>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Tag size reflects frequency or importance
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Filter tags by different categories
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Visualize popular topics and trends
            </p>
          </div>
          <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg">
