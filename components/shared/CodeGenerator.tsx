...
export const extractComponentSource = async (componentName: string): Promise<string> => {
  try {
...
export const useDynamicCode = (componentName: string, activeTab: 'jsx' | 'css') => {
...
export const extractComponentSourceFromFunction = (component: React.ComponentType): string => {
  try {
